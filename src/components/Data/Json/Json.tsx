...
import './json.less'
import type { ComponentProps } from '../../../utils/PiziComponent/PiziComponent';
import { getClassName } from "pizi-utils/dom"
import { REGEX } from "pizi-utils/regex"
...
export const Json: React.FC<JsonProps> = ({ json, ...props }) => {
	...
	function renderJsonObject(object: any, keyPrefix = ""){
        ...
        if(Array.isArray(object)){
            ...
            return <span key={keyPrefix} className={getClassName("json-boolean", {false: !object})}>{object.toString()}</span>
	...
	return 	<div className={getClassName("pizi-json")}>
